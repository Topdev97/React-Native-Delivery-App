...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modal)/dish` | `/dish` | `/(modal)/filter` | `/filter` | `/(modal)/location-search` | `/location-search` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/four` | `/four` | `/(tabs)/` | `/(tabs)` | `/(tabs)/three` | `/three` | `/(tabs)/two` | `/two` | `/+html` | `/address` | `/basket` | `/details` | `/menus` | `/modal` | `/orderDetails` | `/orders` | `/profile` | `/razorpay` | `/review` | `/trackOrder`;
  // prettier-ignore
